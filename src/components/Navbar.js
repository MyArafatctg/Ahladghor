...
const Navbar = () => {
  ...
  const {setShowSearch, getCartCount, token, nevigate,setToken,setCartItem} = useContext(ShopContext);
    ...
    <div className="flex items-center justify-between py-5 font-medium">
      ...
      <div className='flex items-center gap-6'>
        ...
        <div className='group relative'>
            <img onClick={()=> token ? null : nevigate('/login')} className='w-5 cursor-pointer' src={assets.profile_icon} alt="" />
        {/**Dropdown Menu */}
        {
          token && 
          ...
          <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded'>
            ...
            <p onClick={()=>nevigate('/orders')} className='cursor-pointer hover:text-black'>Orders</p>
